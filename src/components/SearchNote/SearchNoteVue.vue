...
<template>
    <main>
        <div class="input-container">
            <input type="text" name="text" class="input_search" placeholder="search...">
    ...
    <div class="container w-100" style="margin-left: -10px;">
            <span>
                <i class="fa-regular fa-clock me-1 mt-5" style="color: rgb(133, 133, 133);">
                </i> 
                Pass day
            </span><br/>
            <span>
                <i class="fa-regular fa-clock me-1 mt-2" style="color: rgb(133, 133, 133);">
                </i> 
                Pass 30 days
            </span>
        </div>
